...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='PISTON', id=1, devices={'master': DeviceState(values=OrderedDict([('encodedChord', 'uint32_t')]), events=['playFChord', 'playBbChord', 'playD5Chord', 'playAbChord', 'playDbChord', 'playCChord', 'playeChord', 'playaChord', 'playDChord', 'playGChord', 'playAChord', 'playC_InvertedChord', 'playF_InvertedChord', 'retractAll', 'engageMuteBar', 'disengageMuteBar']), 'tablet': DeviceState(values={}, events=[])})]
